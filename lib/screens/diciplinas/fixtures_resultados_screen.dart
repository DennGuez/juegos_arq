                      ...
                      return Container(
                        decoration: BoxDecoration(
                          ...
                          child: ExpansionTile(
                            ...
                            collapsedIconColor: Color(0xff151515),
                            title: Text(diciplinaList[index]['disciplina'], 
                              style: TextStyle(color: Color.fromARGB(255, 21, 21, 21), fontWeight: FontWeight.w600, fontSize: 19),),
                            children: [
                              ListView.builder(
                                shrinkWrap: true,
                                ...
                                itemBuilder: (context, index2) {
                                  return Container(
                                    ...
                                    child: ExpansionTile(
                                      iconColor: Color(0xff151515),
                                      collapsedIconColor: Color(0xff151515),
                                      title: Text(diciplinaList[index]['modalidad'][index2]['nombre'], style: TextStyle(color: Color.fromARGB(255, 21, 21, 21), fontSize: 18),),
                                      children: [
